...
export type TutorialDefinition = {
  ...
  /**
   * Didacticiel proposé comme suite directe sur la dernière étape.
   * Le parcours courant est terminé avant le lancement de cette suite.
   */
  followUpTutorialKey?: string;
