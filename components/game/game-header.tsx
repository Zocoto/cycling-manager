    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="order-3 -mx-3 grid w-[calc(100%+1.5rem)] grid-cols-2 items-center justify-items-center gap-1 border-t border-white/10 pb-0.5 pl-3 pr-[4.35rem] pt-1.5 sm:mx-0 sm:ml-auto sm:flex sm:w-full sm:flex-wrap sm:justify-end sm:gap-2 sm:px-0 sm:pb-0 sm:pt-2 lg:order-none lg:w-auto lg:flex-nowrap lg:border-t-0 lg:pt-0"
        >
