...
import { getTeamKitPattern, type TeamKitPattern } from "@/lib/game/race-visuals";
    ...
    >
      ...
      >
        ...
        <path
          ...
          strokeDasharray="1 1"
        />
        <path d="M40 27h4v8h-4Z" fill="#E8EEE9" stroke="#64756D" strokeWidth="0.6" />
      ...
      >
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <path d="m40 44 7 1" stroke="#F5F7F6" strokeWidth="1.8" strokeLinecap="round" />
      </g>
      <g
      ...
      >
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <path d="m47 44 7 1" stroke="#F5F7F6" strokeWidth="1.9" strokeLinecap="round" />
      </g>
      ...
      >
        <path d="m42 39 6 3 6 3" fill="none" stroke="#17261E" strokeWidth="1.25" />
        <path d="M39 38h5m8 8h5" stroke="#E9EFEC" strokeWidth="1.4" strokeLinecap="round" />
      </g>
  ...
  return (
    ...
    >
      ...
      <g fill="none" data-detailed-race-bike="true">
        <ellipse className={isMoving ? "cm-bike-wheel" : ""} cx="11" cy="21" rx="9" ry="3.7" stroke="#0E1814" strokeWidth="2" />
        <ellipse cx="11" cy="21" rx="8" ry="2.8" stroke="#DCE8E2" strokeWidth="0.65" strokeDasharray="2 1.5" />
        <ellipse className={isMoving ? "cm-bike-wheel" : ""} cx="79" cy="21" rx="9" ry="3.7" stroke="#0E1814" strokeWidth="2" />
        <ellipse cx="79" cy="21" rx="8" ry="2.8" stroke="#DCE8E2" strokeWidth="0.65" strokeDasharray="2 1.5" />
        <path d="M11 21 36 14l17 7H11l25 7 17-7h26" stroke={visual.primaryColor} strokeWidth="1.7" strokeLinejoin="round" />
        <path d="m53 21 13-9m-3 0h9" stroke="#DCE8E2" strokeWidth="1.2" strokeLinecap="round" />
        <path d="M36 14 36 28" stroke={visual.accentColor} strokeWidth="0.9" />
      </g>
      <g className={isMoving ? "cm-bike-leg-top-back" : ""}>
        <path d="m40 14-11-5m11 19-11 5" stroke={skin.skinTone} strokeWidth="2" strokeLinecap="round" />
      </g>
      ...
      <RaceJerseyOverlay
        ...
        visual={visual}
      />
      <ellipse cx="66" cy="21" rx="4.9" ry="4.1" fill={skin.skinTone} stroke={skin.skinShadow} strokeWidth="0.6" />
      <g data-race-helmet-team-colors="true">
        <path
        ...
        <path d="m65 17.2.2 2.3m2-2.1-.2 2.3m2-.9-.5 1.2" stroke={helmet.accent} strokeWidth="0.55" />
      </g>
    </svg>
  );
}
    ...
    if (rider.classificationJersey === "mountain") {
      ...
      return (
        <g clipPath={`url(#${clipId})`}>
          {dots.map(([cx, cy]) => (
            <circle key={`${cx}-${cy}`} cx={cx} cy={cy} r={mode === "side" ? 1.7 : 2} fill={visual.accentColor} />
          ))}
        </g>
      );
    }
...
function TopPattern({ pattern, color }: { pattern: TeamKitPattern; color: string }) {
  if (pattern === "center_stripe") return <rect x="44" y="12" width="6" height="18" rx="2" fill={color} />;
  if (pattern === "halves") return <path d="M47 12.3c8 0 14 3.8 14 8.7s-6 8.7-14 8.7Z" fill={color} />;
  if (pattern === "chevron") return <path d="m34 15 13 7 13-7 1.5 3.4L47 27 32.5 18.5Z" fill={color} />;
