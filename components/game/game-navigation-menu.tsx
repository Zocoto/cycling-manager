...
export const NAVIGATION_GROUPS_FR = [
  ...
  },
  {
    ...
    links: [
      ...
      ["CC & CM", "/jeu/championnats-internationaux"],
...
export const NAVIGATION_GROUPS_EN = [
  ...
  },
  {
    ...
    links: [
      ...
      ["Continental & world championships", "/jeu/championnats-internationaux"],
            ...
            >
              <span className="grid h-10 w-12 shrink-0 place-items-center overflow-hidden rounded-lg border border-white/15 bg-white/10">
                <span
                  ...
                  className={`fi fi-${federationCountryCode.toLowerCase()} text-2xl shadow-sm`}
                />
              </span>
