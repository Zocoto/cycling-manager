...
function ActiveRules({ stageType }: { stageType: string }) {
  const rules = [
    ...
    ["Terrain", "FL, MO, HIL, COB et DH sont pondérées par le profil, la pente et le revêtement."],
    ["Énergie", "La forme constitue le capital initial ; STA et RES déterminent la capacité à tenir le rythme et les efforts."],
