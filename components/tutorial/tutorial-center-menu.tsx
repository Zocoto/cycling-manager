...
const CRITERIUM_CALENDAR_ROUTE =
  "/jeu/calendrier?formation=criterium";
          ...
          <div className="max-h-[min(620px,calc(100vh-100px))] overflow-y-auto p-4 max-sm:max-h-[55dvh] max-sm:p-3">
            ...
            <div className="mt-2 grid gap-3">
              ...
              <TutorialLinkEntry
                ...
                description="Inscrivez cinq coureurs depuis le calendrier, puis suivez la course dans le véritable replay Résultats / Live."
