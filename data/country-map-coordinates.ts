export type CountryMapCoordinate = {
  latitude: number;
  longitude: number;
};

// Average country coordinates from Google DSPL countries.csv (CC BY 4.0).
export const COUNTRY_MAP_COORDINATES: Readonly<
  Record<string, CountryMapCoordinate>
> = {
  ...
  SS: { latitude: 7.862685, longitude: 29.694923 },
