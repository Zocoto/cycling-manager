...
export const TEAM_INFRASTRUCTURE_SPECIALIZATION_PROPOSALS: readonly InfrastructureSpecializationProposal[] = [
  ...
  {
    buildingCode: "roster_management_center",
    buildingName: "Pôle de gestion sportive",
    ...
    options: [
      option({
        code: "retention_cell",
        name: "Cellule de fidélisation",
        identity: "Sécuriser les cadres sans réduire artificiellement tous les salaires de l’équipe.",
        primaryEffect: "−3 %, −4 % puis −5 % sur le salaire des futures prolongations.",
        secondaryEffect: "La réduction est enregistrée sur le nouveau contrat et reste visible dans la proposition.",
        guardrail: "Les contrats déjà signés et les recrutements extérieurs ne sont jamais recalculés.",
      }),
      option({
        code: "rotation_management",
        name: "Gestion des rotations",
        identity: "Rendre de la fraîcheur aux coureurs réellement laissés au repos.",
        primaryEffect: "Après 48 h sans course, les 3, 4 puis 5 coureurs les plus fatigués gagnent +1 forme.",
        secondaryEffect: "La sélection est automatique et privilégie les formes les plus basses.",
        guardrail: "Un coureur à 100 de forme ou ayant couru pendant les deux jours concernés ne reçoit rien.",
      }),
      option({
        code: "youth_pathway",
        name: "Passerelle espoirs",
        identity: "Conserver davantage de talents formés par le club sans ouvrir ces places au marché.",
        primaryEffect: "+3, +4 puis +5 places réservées aux coureurs issus du Centre de formation.",
        secondaryEffect: "Ces places complètent la capacité générale du bâtiment.",
        guardrail: "Les enchères, agents libres et transferts externes ne peuvent jamais consommer ces places réservées.",
      }),
    ],
  },
  {
