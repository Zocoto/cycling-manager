...
export const releases = [
  {
    ...
    description:
      "Depuis le Patch #4, Cyclo Stratège approfondit la simulation des courses, enrichit les outils de gestion et affine sensiblement l’expérience sur ordinateur comme sur mobile.",
    features: [
      "Courses et directs — Nouveau comportement adaptatif du peloton : poursuite continue, relais dans les échappées, fenêtres d’attaque et réactions plus naturelles selon la situation de course. La variabilité autour des favoris, des blessures et des scénarios a été retravaillée sans altérer les simulations historiques. Les directs gagnent en vie, avec des animations synchronisées, des chronos intermédiaires dynamiques et une meilleure représentation des contre-la-montre. Les bonifications de temps, les classements précédents sous les replays, les interviews d’après-course et les éditions italiennes de La Cyclogazetta complètent cette évolution.",
      "Calendrier et championnats — De nouvelles courses régionales réservées aux équipes du continent concerné enrichissent le calendrier national de la Saison 2. Les inscriptions affichent désormais la forme, signalent les conflits et remontent les compositions invalides sur le tableau de bord. Les courses par étapes conservent des abandons, non-partants, disponibilités et classements cohérents. Les championnats nationaux sont sécurisés de bout en bout, de l’inscription à l’archivage des résultats.",
      "Infrastructures et staff — Les architectes peuvent désormais disposer d’un talent autorisant un second chantier en parallèle et, dès le niveau 2, d’une caractéristique améliorant progressivement l’efficacité d’un bâtiment. Les formateurs rejoignent le jeu comme onzième métier de staff pour optimiser les stages de l’Académie des métiers. Les talents des ingénieurs R&D sont pleinement pris en compte, la progression des infrastructures est rééquilibrée et de nouveaux objets permettent d’accélérer un chantier, de perfectionner un membre du staff ou d’organiser un recrutement personnalisé.",
      "Santé et formation — La planification des stages de forme a été entièrement repensée avec un calendrier lisible, des réservations groupées et un contrôle immédiat des conflits. Les affectations des kinés passent à une matrice adaptée au mobile. L’effectif junior reste modifiable jusqu’au Jour 7 et un jeune peut être libéré du Centre de formation. L’équipe de développement gagne son expérience, son effectif dédié et ses récompenses de podiums juniors. La progression des jeunes, les mini-jeux d’entraînement, les bibliothèques internationales de noms et la diversité visuelle des coureurs ont également été enrichis.",
      "Sponsors, finances et Fan Club — Les objectifs sponsors correspondent plus finement à leur philosophie sportive, notamment pour la préférence nationale et le développement des jeunes. Dix sponsors internationaux issus du bien-être et de l’hygiène arrivent avec leurs identités et maillots, aux côtés de nouveaux partenaires régionaux bretons. La boutique du Fan Club est rééquilibrée avec un marché de gros quotidien commun à toutes les équipes, tandis que l’affichage financier se recentre sur les flux futurs utiles à la décision.",
      "Matériel et inventaire — Le matériel peut être acheté en groupe grâce à un véritable panier. La matrice d’équipement est restaurée sur ordinateur, les emplacements latéraux sont consolidés et les bonus restent correctement appliqués jusque dans les valeurs élevées de la simulation. Un nouveau talent de mécanicien permet d’intervertir les roues avant et arrière. Les consommables peuvent être attribués en lot et l’effet de chaque capacité spéciale est systématiquement rappelé avant de choisir son bénéficiaire.",
      "Progression et palmarès — Les palmarès de carrière des coureurs et des équipes sont enrichis, et les trophées restant à conquérir deviennent visibles. De nouveaux objectifs portent sur l’expérience des coureurs, accompagnés de récompenses de recrutement instantané. La progression du Directeur Sportif s’arrête proprement au niveau maximal et un message de bienvenue accompagne automatiquement les nouveaux Directeurs Sportifs.",
      "Mobile, accessibilité et confort — L’ergonomie mobile évolue avec un en-tête allégé, une navigation de pouce, un hub de course et une bulle de chat. Les panneaux et barres d’action restent accessibles au-dessus de la navigation sur les petits écrans. Le chat général est recentré sur les échanges, la rubrique Effectif sur les données sportives, et une navigation retour est ajoutée aux profils. La version bilingue français-anglais est généralisée et l’application peut être installée sur mobile avec des notifications pour les événements importants et les surenchères.",
    ],
  },
  {
