...
comment on function public.replace_official_stage_results(uuid, jsonb) is
  'Remplace atomiquement tout le classement d une étape officielle afin que les changements de rang et de startlist ne provoquent aucun conflit intermédiaire.';
