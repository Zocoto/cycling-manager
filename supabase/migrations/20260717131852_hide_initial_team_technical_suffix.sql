...
-- ============================================================
-- MASQUAGE DU SUFFIXE TECHNIQUE DES EQUIPES INITIALES
--
-- Le nom stocke en base conserve son suffixe technique afin
-- de garantir son unicite.
--
-- Exemple stocke :
--   Equipe amateur de Paul Paul · C5E9
--
-- Exemple retourne a l interface :
--   Equipe amateur de Paul Paul
-- ============================================================
...
is
  'Retourne le resume visible de l equipe du Directeur Sportif sans exposer le suffixe technique du nom.';
