...
import {
  completeCriteriumDiscoveryAction,
} from "@/app/jeu/courses/criterium-de-la-decouverte/actions";
  ...
  return (
    <main className="min-h-screen bg-[#EAF5F3] text-[#082A2A]">
      ...
      <section className="mx-auto max-w-[1500px] px-5 py-8 sm:px-8 sm:py-12">
        ...
        <section className="mt-6 overflow-hidden rounded-2xl border border-[#315B3E]/15 bg-white shadow-[0_18px_45px_rgba(19,60,46,0.09)]">
          ...
          <div className="grid gap-6 p-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
            ...
            {isCompleted ? (
              ...
              <form
                action={completeCriteriumDiscoveryAction}
              >
