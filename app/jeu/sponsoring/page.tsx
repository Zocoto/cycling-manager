    ...
    <main className="min-h-screen bg-[#EAF5F3] text-[#082A2A]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1500px] px-5 py-10 sm:px-8 sm:py-14">
          ...
          <header className="mt-7 flex flex-wrap items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-lg leading-8 text-[#48665F]">
                Comparez les budgets, la durée des
                contrats et les objectifs proposés avant
                de choisir le partenaire principal de votre
                équipe.
              </p>
            </div>
            ...
            {!offersError ? (
              <div className="rounded-2xl border border-[#315B3E]/20 bg-white/85 px-5 py-4 text-right shadow-[0_14px_34px_rgba(19,60,46,0.08)]">
                <p className="text-2xl font-black text-[#082A2A]">
                  {offers.length}
                </p>
          ...
          {offersError ? (
            <OffersErrorMessage message={offersError} />
          ) : null}
          ...
          {!offersError && offers.length > 0 ? (
            <p className="mt-6 text-sm leading-7 text-[#60756E]">
              ...
              l’offre et ne changent pas lors du
              rechargement de la page. Ils seront reliés
              au calendrier sportif réel dans une future
              évolution.
            </p>
          ) : null}
        </div>
    ...
    <aside className="mt-8 flex items-start gap-4 rounded-2xl border border-[#278B70]/20 bg-[#D7EEE8]/85 px-5 py-4 shadow-[0_12px_30px_rgba(19,60,46,0.06)]">
      ...
      <div>
        ...
        <p className="mt-1 text-sm leading-6 text-[#48665F]">
          Ces offres ont été générées pour votre Directeur
          Sportif et enregistrées pour la saison actuelle.
          Leurs budgets, durées et objectifs resteront
          identiques lors de vos prochaines visites.
        </p>
      </div>
    </aside>
  );
...
function SponsorOfferCard({
  ...
  return (
    <article
      ...
      style={{
        borderColor: `${sponsor.colors.primary}38`,
      }}
    >
      <div
        aria-hidden="true"
      ...
      <div className="p-6 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <SponsorIdentityBadge offer={offer} />
        ...
        <div className="mt-6">
          ...
          <h2 className="mt-4 text-2xl font-black text-[#082A2A]">
            {sponsor.name}
          </h2>

          <p className="mt-3 min-h-20 leading-7 text-[#60756E]">
            {sponsor.description}
          </p>
        </div>
        ...
        <section className="mt-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
          ...
          <OfferSummaryCard
            ...
            value="+7 %"
            detail="Si les 7 objectifs sont remplis"
          />
        </section>
        ...
        <p className="mt-3 text-center text-xs font-semibold leading-5 text-[#7A8C86]">
          ...
          définitive du contrat seront ajoutées à la
          prochaine étape.
        </p>
      </div>
    </article>
  ...
  return (
    <div className="flex min-w-0 items-center gap-4">
      ...
      <div className="min-w-0">
        <p className="truncate text-sm font-black text-[#082A2A]">
          {sponsor.shortName}
        </p>
...
function OfferSummaryCard({
  ...
  return (
    <div className="rounded-xl border border-[#315B3E]/15 bg-[#F6FAF8] p-4">
      ...
      <p className="mt-2 text-xl font-black text-[#082A2A]">
        {value}
      </p>
    ...
    <li className="flex gap-3 bg-white px-4 py-4">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex flex-wrap items-start justify-between gap-2">
          <p className="font-black leading-6 text-[#082A2A]">
            {objective.name}
          </p>
